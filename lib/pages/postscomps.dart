...
class UploadComps extends StatefulWidget {
  @override
  _UploadCompsState createState() => _UploadCompsState();
}

class _UploadCompsState extends State<UploadComps> {
  ...
  createPostinFirestore({String? mediaUrl, String? description}) {
    FirebaseFirestore.instance.collection("compsnew").add({
      "description": description,
      "mediaUrl": mediaUrl,
      "timestamp": new DateTime.now()
    }).then((response) {
      //print(response.id);
      Navigator.push(context, MaterialPageRoute(builder: (_) => HomeComps()));
      ;
      clearimage();
    });
  }
