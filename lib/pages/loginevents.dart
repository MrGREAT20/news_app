...
class LoginEvents extends StatefulWidget {
  @override
  _LoginEventsState createState() => _LoginEventsState();
}

class _LoginEventsState extends State<LoginEvents> {
      ...
      appBar: NewGradientAppBar(
        ...
        actions: [
          TextButton(
            onPressed: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (_) => HomeEvents()));
            },
            child: Text(
              "Skip",
              style: TextStyle(
                      ...
                      onPressed: () {
                        if (result == mainans && result2 == mainans2) {
                          ...
                          Navigator.push(context,
                              MaterialPageRoute(builder: (_) => HomeEvents()));
                        } else
                          return null;
                      },
                      child: Text(
